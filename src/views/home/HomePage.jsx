    ...
    >
      <div className="container mx-auto">
        <div className="max-w-2xl px-4 md:px-12">
          <h1 className="text-3xl md:text-5xl font-semibold text-black">{title}</h1>
...
const Promotion = () => {
  return (
    <div className="promotion px-4 md:px-0">
      <div className="container mx-auto">
        <h1 className="text-2xl md:text-3xl font-semibold">Event Promotion</h1>
  ...
  return (
    <div className="story px-4 md:px-0">
      ...
      <div className="image my-6 md:my-10 relative">
        ...
        <a href="#" className="absolute inset-0 flex items-center justify-center text-lg md:text-xl">
