...
export default function PaymentSection() {
  ...
  return (
    <div className="lg:w-7/12 w-full p-4 border border-primary rounded-xl mt-10">
      <h1 className="text-2xl text-start py-4">Payment Method</h1>
      <div className="flex gap-4">
        <Link to={"/InputInfo"}  className="btn btn-primary w-full">Cash on Delivery</Link>
      </div>
      <div className="flex flex-col gap-2 items-start mt-4 w-full">
        ...
        >
          <input
            ...
            className={`input input-bordered flex-1 border-base-300 ${discount?.validtion === false ? "border-red-500" : "border-green-500"}`}
            name="coupon"
      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <div>
          ...
          {discount?.validtion && <div className="flex justify-between items-center py-2">
          ...
          <div className="flex justify-between items-center py-2">
            ...
            <span className="text-2xl font-semibold text-primary">
              ${totalPrices + (deliveryCost || 0) - (totalPrices * (discount?.discountPercentage || 0) / 100)}
            </span>
          </div>
